...
public class LevelManager
{
	...
	private void createLevel()
	{
		...
		addSprite ( Wall.TABLE, 7, 2, 1,1, "PtTableVt.png", 0,-5 );
		addSprite ( Wall.TABLE, 8, 2, 1,1, "PtTableHz.png", 0,-5 );
		addSprite ( Wall.WALL, 9, 2, 1,1, "1x1ObjP2.png", -0, -10 );
		
		// sprites angle haut gauche
		addSprite ( Wall.WALL, 3, 5, 1,1, "1x1ObjP2.png", -0,-10 );
		...
		addSprite ( Wall.WALL, 3, 9, 1,1, "1x1ObjP2.png", -0, -10 );
		...
		addSprite ( Wall.WALL, 11, 5, 1,1, "1x1ObjP2.png", -0,-10 );
		...
		addSprite ( Wall.WALL, 11, 9, 1,1, "1x1ObjP2.png", -0,-10 );
		
		//sprites barre du bas
		addSprite ( Wall.WALL, 5, 12, 1,1, "1x1ObjP2.png", -0,-10 );
		addSprite ( Wall.TABLE, 6, 12, 1,1, "PtTableHz.png", 0,-5 );
		addSprite ( Wall.TABLE, 7, 12, 1,1, "PtTableVt.png", 0,-5 );
		addSprite ( Wall.TABLE, 8, 12, 1,1, "PtTableHz.png", 0,-5 );
		addSprite ( Wall.WALL, 9, 12, 1,1, "1x1ObjP2.png", -0,-10 );
